...
public class DiffVis extends PApplet {
...
public PImage getDifference(PImage input1, PImage input2)
{
  ...
  for (int i = 0; i < output.pixels.length; i++) {
    ...
    int diffColor = color(RDiff * gain, GDiff * gain, BDiff * gain);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "DiffVis" };
    if (passedArgs != null) {
